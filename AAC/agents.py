...
from AAC.misc import hard_update, gumbel_softmax, onehot_from_logits
from AAC.policies import DiscretePolicy

class AttentionAgent(object):
    """
    General class for Attention agents (policy, target policy)
    """
    def __init__(self, num_in_pol, num_out_pol, agent_name, hidden_dim=64,
