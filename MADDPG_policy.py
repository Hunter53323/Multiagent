...
from MADDPG.networks import MLPNetwork
from MADDPG.misc import soft_update, average_gradients, onehot_from_logits, gumbel_softmax
from MADDPG.agents import DDPGAgent
import defination
import numpy as np
...
class MADDPG(object):
    ...
    def init_from_env(cls, env, agent_alg="MADDPG", adversary_alg="MADDPG",
        ...
        alg_types = ["MADDPG" for _ in range(len(env.agents))]
        ...
        for acsp, obsp, algtype, aname in zip(env_action_space, env_observation_space,
                                       alg_types, env.agents_name):
            num_in_pol = obsp
            num_out_pol = acsp
            #print(acsp)
            '''
